...
?>
	<div class="wrap" style="width:98%;">
		...
		<div class="updated"><p><strong><em><?php _e('Adjusting the settings on this page will change the Admin Bar display for this Website only!', 'wp-my-admin-bar');?></em></strong></div>
			<div class="metabox-holder has-right-sidebar">
<!-- left side -->
				<div id="post-body"><div id="post-body-content">
					<div class="postbox"><div class="inside">
						<p><?php _e('The <u>WP-MyAdminBar</u> Plugin, replaces and expands the Wordpress Administration Bar, adding a new My Sites menu with extended options, a My Cache menu for quick cache access and My Tools for all WP Developers and Blogger needs.', 'wp-my-admin-bar');?></p>
						...
						<h3><span><?php _e('Display Settings', 'wp-my-admin-bar');?></span></h3>
							<div class="inside">
								...
								<form method="post" action="">
									...
									<p><?php _e('Select', 'wp-my-admin-bar');?> [<?php _e('show', 'wp-my-admin-bar');?>] <?php _e('for each cache plugin this Website uses to enable a quick link to the selected cache plugin under the My Cache menu', 'wp-my-admin-bar');?>.</p>
				...
				<div  class="postbox">
					<h3><span><?php _e('Option Data', 'wp-my-admin-bar');?></span></h3>
						...
						<p><?php _e('Below is the Admin Bar Option Values that this Website has within the database.', 'wp-my-admin-bar');?></p>
							<ul>
								<li style="overflow:hidden;"><strong><?php _e('Admin Bar Option', 'wp-my-admin-bar');?></strong>: <small><?php echo $myadminbar;?></small></li>
								<li style="overflow:hidden;"><strong><?php _e('My Cache Option', 'wp-my-admin-bar');?></strong>: <small><?php echo $wpmycache;?></small></li>
				...
				<div  class="postbox"><div class="inside">
					<p><?php _e('Disabling or deleting this plugin, through the WP Administration area, clears the option settings above from the database.', 'wp-my-admin-bar');?></p>
				</div></div> <!-- end inside and postbox -->
