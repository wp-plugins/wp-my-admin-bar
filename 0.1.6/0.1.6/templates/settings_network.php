...
<?php echo $setting_tabs;?>
			<div class="fade error" id="message" onclick="this.parentNode.removeChild(this)"><p><strong><em><?php _e('The display options for this page are Network wide. Meaning all Websites within this Network will use the settings below.', 'wp-my-admin-bar');?> <?php if ( $_GET['tab'] != "custom_settings" ) { _e('Each Website within a Network can have unique display options set by visiting the Admin Bar settings page for that Website.', 'wp-my-admin-bar'); }?></em></strong></div>
					...
					<h3><span><?php _e('Custom Settings', 'wp-my-admin-bar');?></span></h3>
						<div class="inside">
							...
							<?php wp_nonce_field('my_custom_action','my_custom_nonce');?>
								...
								<p><strong><?php _e('Display WP Icon in My Sites/Cache Menu', 'wp-my-admin-bar');?></strong>: <input class="valinp" type="radio"  name="wpicon" value="show" <?php echo $wpicon_on;?> /> [<?php _e('show', 'wp-my-admin-bar');?>]&nbsp;&nbsp;&nbsp;<input class="valinp" type="radio" name="wpicon" value="hide" <?php echo $wpicon_off;?> /> [<?php _e('hide', 'wp-my-admin-bar');?>]</p>
								<p><strong><?php _e('Display Site IDs in My Sites Menu', 'wp-my-admin-bar');?></strong>: <input class="valinp" type="radio"  name="siteids" value="show" <?php echo $siteids_on;?> /> [<?php _e('show', 'wp-my-admin-bar');?>]&nbsp;&nbsp;&nbsp;<input class="valinp" type="radio" name="siteids" value="hide" <?php echo $siteids_off;?> /> [<?php _e('hide', 'wp-my-admin-bar');?>]</p>
